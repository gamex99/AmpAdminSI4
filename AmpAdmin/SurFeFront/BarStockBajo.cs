...
ORDER BY
    [stock] ASC"; // Ordenamos para ver los más bajos primero
            ...
            // Modificado: Aumentamos a 1.20 para dar espacio a la etiqueta del número
            ...
            // (Modificado para mostrar la cantidad al final)
            for (int i = 0; i < dataValues.Length; i++)
            {
                // "N0" formatea como Número sin decimales (ej: 5)
